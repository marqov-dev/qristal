"""Reuse the bounded readout image harness for a predeclared 26-case calibration/held-out experiment."""
...
def main(output):
    ...
    print("PASS: 26 calibration/held-out cases, singular control rejected; container cleanup verified")
