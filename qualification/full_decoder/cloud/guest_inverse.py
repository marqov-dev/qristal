...
try:
    ...
    for mode,marker in [('negative','PASS: 12 inverse rejected inputs'),('qpp','PASS: 140 controlled inverse complex-state cases plus 20 legacy fallback observations'),('sparse','PASS: 20 sparse inverse interference cases')]:
