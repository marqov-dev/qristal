"""Overlay local program-validation fixtures on an existing CPU image and test offline.
...
try:
    ...
    for file in ['preparation_binding.py','test_preparation_binding.py']:
...
for test in ['test_preparation_binding.py']:
